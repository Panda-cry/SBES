...
namespace Manager
{
	public class ServiceCertValidator : X509CertificateValidator
	{
		...
		public override void Validate(X509Certificate2 certificate)
		{
			...
			X509Certificate2 certificateServer = CertManager.GetCertificateFromStorage(StoreName.My, StoreLocation.LocalMachine, srvCertCN);

			if (!certificate.Issuer.Equals(certificateServer.Issuer))
				throw new Exception("Not same issuer");
		}
	}
}
